...
PORT = 80  # 监听端口
ASSET_URL = 'https://kubernetes-dev.github.io/gh-proxy'  # 主页
...
logo_r = requests.get(ASSET_URL + '/github.png', timeout=10).content
...
def logo():
    return Response(logo_r, content_type='image/png')
